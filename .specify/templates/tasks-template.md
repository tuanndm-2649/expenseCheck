...
- [ ] T004 Setup Supabase schema, migrations, and rollback notes
- [ ] T005 [P] Implement authentication/authorization framework
- [ ] T006 [P] Define and apply Supabase RLS policies for user-owned data
- [ ] T007 Create base models/entities that all stories depend on
- [ ] T008 Configure error handling and logging with sensitive-data redaction
...
- [ ] T017 [US1] Add logging for user story 1 operations (no sensitive values)
- [ ] T018 [US1] Verify responsive behavior at 360px, tablet, and desktop
...
- [ ] TXXX Security hardening and RLS policy audit
- [ ] TXXX Responsive/accessibility audit across supported breakpoints
